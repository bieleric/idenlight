...
describe('Demo Tutorial Store', () => {
  ...
  test('Get State Value', () => {
    ...
    expect(demoTutorialStore.getConnectionTutorialName).toBe(
      demoTutorialStore.connectionTutorialName
    )
    ...
    expect(demoTutorialStore.getCurrentTutorialSteps).toBe(
      demoTutorialStore.connectionTutorialSteps
    )
    expect(demoTutorialStore.getConnectionTutorialSteps).toBe(
      demoTutorialStore.connectionTutorialSteps
    )

...
<template>
    <div class="d-flex flex-column col-12 mx-auto">
        <div @click="activate" data-type="activateUser" id="focus-user" :class="{'focus d-flex col-12 p-2 mb-3': true, 'active-focus': state.userActive}">
            <div id="user-button" class="col-12 d-flex justify-content-between align-items-center text-light">
        ...
        <div @click="activate" data-type="activateDeveloper" id="focus-developer" :class="{'focus d-flex col-12 p-2 mb-3': true, 'active-focus': !state.userActive}">
            <div id="user-button" class="w-100 d-flex justify-content-between align-items-center text-light">
                <div class="focus-image-container h-100">

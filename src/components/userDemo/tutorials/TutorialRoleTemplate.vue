      ...
      <div class="font-extra-large text-uppercase">
        <span
          v-if="
            (demoTutorialStore.getCurrentTutorial === demoTutorialStore.getConnectionTutorialName &&
              demoTutorialStore.currentStep === 1) ||
            ...
            (demoTutorialStore.getCurrentTutorial === demoTutorialStore.getPresentTutorialName &&
              demoTutorialStore.currentStep === 1)
          "
          data-type="alumniTitle"
          >{{ t('tutorial.roles.alumni') }}</span
        >
        <span
          v-if="
            (demoTutorialStore.getCurrentTutorial === demoTutorialStore.getIssueTutorialName &&
        ...
        <span
          v-if="
            ...
            demoTutorialStore.currentStep === 4
          "
          data-type="employerTitle"
          >{{ t('tutorial.roles.employer') }}</span
        >
      </div>
    </div>
      ...
      <img
        v-if="
          ...
          (demoTutorialStore.getCurrentTutorial === demoTutorialStore.getPresentTutorialName &&
            demoTutorialStore.currentStep === 1)
        "
        src="/trust_triangle_focus_alumni.png"
        class="role-image"
        data-type="alumniImage"
      />
      <img
        v-if="
          (demoTutorialStore.getCurrentTutorial === demoTutorialStore.getIssueTutorialName &&
          ...
          (demoTutorialStore.getCurrentTutorial === demoTutorialStore.getRevokeTutorialName &&
            demoTutorialStore.currentStep === 1)
        "
        src="/trust_triangle_focus_htw.png"
        class="role-image"
        data-type="htwImage"
      />
      <img
        v-if="
          ...
          demoTutorialStore.currentStep === 4
        "
        src="/trust_triangle_focus_employer.png"
        class="role-image"
        data-type="employerImage"
      />
    </div>
  </div>
</template>
